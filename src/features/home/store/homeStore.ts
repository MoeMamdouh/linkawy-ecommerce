...
//         } else {
//           console.warn('Apollo products query failed:', productsResult.reason);
//         }
      
//         if (collectionsResult.status === 'fulfilled') {
//           rawCollections = collectionsResult.value.data?.collections?.edges || [];
//         } else {
//           console.warn('Apollo collections query failed:', collectionsResult.reason);
//         }
//       } catch (apolloErr) {
//         console.warn('Apollo Client failed unexpectedly:', apolloErr);
//       }
